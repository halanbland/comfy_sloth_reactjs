    ...
    return (
        <div className={cx("wrapper", { grid: true })}>
            <div className={cx({ grid: true, wide: true })}>
                <div className={cx("intro", { row: true })}>
                    <div
                        className={cx({
                            col: true,
                            "l-6": true,
                    ...
                    >
                        <div className={cx("intro__greeting")}>
                            <h1 className={cx("greeting__heading")}>
                                Design Your
                                <br />
                                Comfort Zone
                            </h1>
                            <p className={cx("greeting__description")}>
                            ...
                            <Link to={"/products"} className={cx("intro__btn")}>
                                Shop now
                            </Link>
                        </div>
                    </div>
            ...
            <div className={cx("featured-product")}>
                <div className={cx({ grid: true, wide: true })}>
                    <h1 className={cx("featured-product__heading")}>
                        Featured Products
                    </h1>
                    <div className={cx("featured-product__underline")}></div>
                    <div className={cx("featured-product__list-wrap")}>
                        <ul
                            className={cx("featured-product__list", {
                                row: true,
                            })}
                        >
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <span className="featured-product__info-name">
                                                    {item.name}
                                                </span>
                                                <span
                                                    className={cx(
                    ...
                    <Link
                        to={"/products"}
                        className={cx("featured-product__btn")}
                    >
                        All product
                    </Link>
                </div>
            ...
            {/* Custom furniture */}
            <div className={cx("custom-furniture")}>
                <div className={cx({ grid: true, wide: true })}>
                    <div className={cx("custom-furniture__head")}>
                        <h2 className={cx("custom-furniture__title")}>
                            Custom Furniture
                            <br />
                            Built Only For You
                        </h2>
                        <p className={cx("custom-furniture__description")}>
                    ...
                    <ul className={cx("custom-furniture__list", { row: true })}>
                        <li className={cx({ col: true, "l-4": true })}>
                            <div className={cx("custom-furniture__list-item")}>
                                <span
                                    className={cx(
                                        "custom-furniture__list-item-icon"
                                    )}
                                >
                                    <svg
                                        stroke="currentColor"
                                ...
                                <p
                                    className={cx(
                                        "custom-furniture__item-description"
                                    )}
                                >
                                    Lorem ipsum, dolor sit amet consectetur
                                    adipisicing elit. Voluptates, ea.
                                    Perferendis corrupti reiciendis nesciunt
            ...
            <div className={cx("join")}>
                <div className={cx({ grid: true, wide: true })}>
                    <h3 className={cx("join__content-sale")}>
                        Join our newsletter and get 20% off
                    </h3>
                    <div className={cx("join__container", { row: true })}>
                        <div className={cx({ col: true, "l-6": true })}>
                            <div className={cx("join__content")}>
                                <p className={cx("join__content-description")}>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Placeat sint unde quaerat
                                    ratione soluta veniam provident adipisci
